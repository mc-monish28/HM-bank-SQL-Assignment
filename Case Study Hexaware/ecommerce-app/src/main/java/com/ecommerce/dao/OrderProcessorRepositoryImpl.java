...
public class OrderProcessorRepositoryImpl implements OrderProcessorRepository {
    ...
    private void verifyCustomerExists(int customerId) throws CustomerNotFoundException {
    ...
    private void verifyProductExists(int productId) throws ProductNotFoundException {
